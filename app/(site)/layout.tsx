...
export default function SiteLayout({ children }: { children: React.ReactNode }) {
  // Footer'da kullanmak için linkleri burada tekrar tanımlıyoruz (Hata almamak için)
  const navLinks = [
  ...
  return (
    <div className="flex flex-col min-h-screen selection:bg-blue-600 selection:text-white antialiased">
<Navbar />
<main className="flex-grow bg-[#FCFCFD] pt-20"> {/* pt-20 navbar boyu kadar boşluk bırakır */}
  {children}
</main>
